...
- Relação de artefatos: foram adicionados as páginas de *login*, *cadastro*, *página inicial* (home colaborador), *sobre* e *adicionar registros*; as páginas *mudar senha* e *meus registros* serão incluidas nas próximas atualizações.
